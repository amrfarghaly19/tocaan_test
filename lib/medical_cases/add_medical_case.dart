...
class AddMedicalCasePage extends StatefulWidget {
  final String Token;

  AddMedicalCasePage({Key? key, required this.Token}) : super(key: key);

  @override
  _AddMedicalCasePageState createState() => _AddMedicalCasePageState();
}

class _AddMedicalCasePageState extends State<AddMedicalCasePage> {
  final _formKey = GlobalKey<FormState>();
  final TextEditingController _doctorNotesController = TextEditingController();
  final TextEditingController _doctorNotes2Controller = TextEditingController();
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              TextFormField(
                controller: _doctorNotes2Controller,
                maxLines: 3,
                style: TextStyle(color: Colors.white),
                decoration: InputDecoration(
